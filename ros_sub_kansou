...
void run_pattern(void){
    ...
    switch(pattern){
            case 0:
                ...
                CommSpeedR = 16;
                CommSpeedL = 17;
                if(sensval_msg_L > 80 || sensval_msg_R > 80){
                   enc_total = 0;
                   trace_flag = 1;
                   MotorR = 14;
                   MotorL = 14;
            ...
            case 43:
                MotorR = 24;
                MotorL = 10;
                if(enc_total >= 0.18 && sensval_msg >= -70 && sensval_msg <= 0){
                    pattern = 44;
                    trace_flag = 0;
                    enc_total = 0;
                }
            ...
            case 53:
                MotorR = 24;
                MotorL = 10;
                if(enc_total >= 0.15&& sensval_msg >= 0 && sensval_msg <= 60){
                    pattern = 54;
                    trace_flag = 0;
                    enc_total = 0;
                }
            ...
            case 90://レンチェン、クランク判断
                if(enc_total >=0.01){
                    ...
                    if(sensval_msg_L >= 80 && sensval_msg_R < 20){
                        pattern = 10;
                        enc_total = 0;  
                    }
                    if(sensval_msg_R >= 80 && sensval_msg_L < 20){
                        pattern = 20;
                        enc_total = 0;
                    }
                }
